...
public class VentanaCarritoCompra extends JFrame {
	...
	private void initialize() {
		...
		btnGuardarFichero.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					int respuesta = JOptionPane.showConfirmDialog(null, "Quieres guardar el carrito en el fichero?",
	...
	/**
	 * Metodo recursivo, encargado de recojer la informacion de la DefaultTableModel
