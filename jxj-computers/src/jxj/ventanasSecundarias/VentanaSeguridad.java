		...
		btnCambiar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (user.getContrasenia().equals(pfActual.getText())
							&& pfNueva.getText().equals(pfConfirmarNueva.getText())) {
						...
						JOptionPane.showMessageDialog(null, "Los campos no coinciden o contraseña incorrecta", "Error",
								0);
					}
					try {
						dbm.disconnect();
